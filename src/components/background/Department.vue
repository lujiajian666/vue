<template>
    <div id="Department">
        ...
        <el-tabs v-model="activeName">
            <el-tab-pane v-for="(item,index) in department" :label="item.name" :name="index|toString">
                ...
                <el-table :data="jobTitle[item.id]" style="width: 100%;text-align: left" max-height="250">
                    ...
                    <el-table-column fixed="right" label="操作" width="120">
                        <template slot-scope="scope">
                            <el-button
                                    @click.native.prevent="deleteRow(scope.$index,item.id)"
                                    type="text"
                                    size="small">
                                移除
                            </el-button>
                            <el-button
                                    @click.native.prevent="editRow(scope.$index,item.id)"
                                    type="text"
                                    size="small">
                                修改
                            </el-button>
